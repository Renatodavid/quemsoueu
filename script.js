...
document.getElementById("download-btn1").addEventListener("click", function () {
  window.open(
    "https://drive.google.com/file/d/1OepZXQ4W_eegjm-snd5dpRbwl3Ib1YIQ/view?usp=sharing",
    "_blank"
  );
});
...
document.getElementById("fale-comigo").addEventListener("click", function () {
  window.open(
    "https://api.whatsapp.com/send?phone=5521987051725&text=Ol%C3%A1%20L%C3%A9o,%20gostaria%20de%20falar%20com%20voc%C3%AA%20sobre%20meu%20projeto.%20Pode%20me%20ajudar?",
    "_blank"
  );
});
